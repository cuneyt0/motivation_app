...
final List<Motivation> quotesEducation = [
  ...
  Motivation(
      ...
      author: "Aristotle"),
  Motivation(note: "Strive for progress, not perfection.", author: ""),
  Motivation(
  ...
  Motivation(
      ...
      author: "Malcolm X"),
  Motivation(
      note: "Learning never exhausts the mind.", author: "Leonardo da Vinci"),
  Motivation(
      note: "The best way to predict the future is to create it",
      author: "Abraham Lincoln"),
  Motivation(note: "Do not wait for the right time, create it.", author: ""),
  Motivation(
